...
# figure and gcf (get current figure) return same id
print(id(fig))
print(id(plt.gcf()))

# most recently created axes and gca (get current axes) return same id
print(id(ax4))
print(id(plt.gca()))

# return a list of all the figures stored in memory
